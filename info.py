...
auth_channel = environ.get('AUTH_CHANNEL''-1001926217649').split()]
auth_grp = environ.get('AUTH_GROUP''-1001926217649').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movies_areaz')
